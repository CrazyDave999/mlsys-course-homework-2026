...
def test_gradient_of_gradient_of_gradient():
    x1 = ad.Variable(name="x1")
    x2 = ad.Variable(name="x2")
    ...
    grad_x1_x1_x1, grad_x1_x1_x2 = ad.gradients(grad_x1_x1, [x1, x2])

    evaluator = ad.Evaluator(
        [y, grad_x1, grad_x1_x1, grad_x1_x1_x1, grad_x1_x1_x2]
    )
    
    x1_val = np.array([[-1.0, 2.0, 0.5, 3.4], [0.3, 0.0, -5.8, 3.1]])
    x2_val = np.array([[2.8, 0.7, -0.1, 0.0], [0.6, 6.6, 3.2, 3.1]])
    
    expected_y = (x1_val**3) * (x2_val**2)
    expected_grad_x1 = 3 * (x1_val**2) * (x2_val**2)
    expected_grad_x1_x1 = 6 * x1_val * (x2_val**2)
    expected_grad_x1_x1_x1 = 6 * (x2_val**2)
    expected_grad_x1_x1_x2 = 12 * x1_val * x2_val
    ...
    check_evaluator_output(
        ...
        expected_outputs=[
            ...
            expected_grad_x1,
            expected_grad_x1_x1,
            expected_grad_x1_x1_x1,
            expected_grad_x1_x1_x2,
        ],
    )
...
if __name__ == "__main__":
    ...
    test_gradient_of_gradient_of_gradient()
